...
<p>&nbsp;</p>
<p class="style17">FIXED DEPOSIT</p>
<hr align="left" width="100%" size="1" noshade="noshade" class="style8" />
<p class="style17">&nbsp; </p>
<p>National Bank Limited offers fixed term savings that will scale up your savings amount wtih the time.</p>
<p>&nbsp;</p>
<p align="justify">
...
<table width="90%" border="0">
  <tr>
    ...
    <td width="97%">Any amount can be deposited.</td>
  </tr>
  ...
  <tr>
    ...
    <td>Premature encashment facility is available.</td>
  </tr>
  ...
  <tr>
    <td><img src="images/postcommentsicon.png"/></td>
    <td>Overdraft facility available against term receipt.</td>
  </tr>
