...
<p>&nbsp;</p>
<p align="left" class="style17">RISK MANAGEMENT COMMITTEE </p>
...
<?php
$qu_com="select * from committee where  comm_id=5 order by pos_index";
...
<td width="34%" style="padding:5px"><strong><?php echo $row['mem_name'];?></strong></td>
