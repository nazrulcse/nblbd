...
<?php
					    ...
					    $branch_info="select * from branchinfo where branch_type='SME' order by  branch_name asc";
						$page_query="select count(*)  AS count_data from branchinfo where branch_type='SME' ";
						//echo  $branch_info;
					   //  $branch_qry=mysql_query($branch_info);
					  
					  $branch_qry=getResultSet(10, 'sl_sme_branch.php?branch=sme', $branch_info,$page_query);
					  //print_r($branch_qry);
...
<p>&nbsp;</p>
<div align="left" style="padding-left:20px; font-size:18px; font-weight:bold; color:#009933; font-family:'Monotype Corsiva';">SME BRANCH LOCATION
...
?>
        ...
        doPages(10, 'sl_sme_branch.php?branch=sme', '');
