...
<a href="contact.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('contact','','img/phone2.png',1)"><img src="img/phone1.png" name="contact" width="32" height="32" border="0" id="contact" title="Contact Us" /></a>
        ...
        <div class="art-sheet">
            ...
            <div class="art-sheet-body">
                ...
                <div class="art-nav">
					...
					<?php
					  ...
					  while($show=mysql_fetch_array($qry))
					  {
					    ...
					    $branch_info="select * from branchinfo";
						$page_query="select count(*)  AS count_data from branchinfo";
					   //  $branch_qry=mysql_query($branch_info);
					  
					  $branch_qry=getResultSet(10, 'sl_dhaka.php', $branch_info,$page_query);
					  //print_r($branch_qry);
                ...
                <div class="art-content-layout" style="border:1px solid red;">
                    <div class="art-content-layout-row">
                        <div class="art-layout-cell art-content">
                          <div class="art-post " >
                              <div class="art-post-body" style="border:1px solid green; float:left;">
...
<p>&nbsp;</p>
<p class="style17">BRANCH INFORMATION - DHAKA</p>
