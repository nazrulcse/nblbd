...
<table width="90%" border="0">
  <tr>
    <td  width="3%"> </td>
    <td width="97%"><img src="images/dedosit_rate.png" width="590px" height="457px"/></td>
  </tr>
...
<td style="padding:5px">
<p>&nbsp;</p>
<p class="style19 style20">Note: Special rate to be offered through Head Office or Subject to prior written approval to Treasury, Head Office.</p></td>
</tr>
