...
<?php
					    ...
					    $branch_info="select * from branchinfo where egp=1 order by  branch_name asc";
						$page_query="select count(*)  AS count_data from branchinfo where egp=1";
						//echo  $branch_info;
					   //  $branch_qry=mysql_query($branch_info);
					  
					  $branch_qry=getResultSet(15, 'sl_e-gp.php?branch=e-gp'.$branch_city, $branch_info,$page_query);
					  //print_r($branch_qry);
