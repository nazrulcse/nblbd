...
<p>&nbsp;</p>
<p align="left" class="style17">ASSET LIABILITY COMMITTEE</p>
...
<?php
$qu_com="SELECT * from committee where	comm_id=4 ORDER BY pos_index";
...
<td width="36%" style="padding:5px"><a href="<?php echo $row['url'];?>"><strong><?php echo $row['mem_name'];?></strong></td>
<td width="45%" style="padding:5px"><strong><?php echo $row['designation'];?></strong></td>
<td width="8%" style="padding:5px"><?php echo $row['com_desig'];?></td>
