        ...
        <div class="art-layout-cell art-content">
            <div class="art-post">
                <div class="art-post-body">
                    ...
                    $depo_type = "SELECT DISTINCT product_category, count( product_category ) cnt_cat FROM product_interest where product_type=2 GROUP BY product_category ORDER BY product_id";
                    ...
                    //print_r($deposit);
                    $all_depo = "select * from product_interest where product_type=2";
                    ...
                    <table width="100%">
                        <tr width="100%">
                            <td style="padding:5px">
                                ...
                                <p class="style17">LENDING INTEREST RATE</p>
    ...
    <div class="art-footer-body">
        ...
        <div class="art-footer-text">
            ...
            <p>
                ...
                <a href="fs_financial_performance.php" class="style8">Financial Performance</a> <span
                    class="style8"> | </span>
