...
<?php
$qu_com="SELECT * from committee where	comm_id=3 ORDER BY pos_index";
...
<td width="39%" style="padding:5px"><a href="<?php echo $row['url'];?>"><strong><?php echo $row['mem_name'];?></strong></a></td>
<td width="34%" style="padding:5px"><strong><?php echo $row['designation'];?></strong></td>
<td width="9%" style="padding:5px"><?php echo $row['com_desig'];?></td>
